    ...
    ggfittext::geom_fit_text(
      ggplot2::aes(fill=factor(.data$Performance.Level),
                   label = paste(ggplot2::after_stat(.data$fill),'\n',
                                 ...
                                 ggplot2::after_stat(as.vector(matrix(unlist(tapply(.data$count,list(.data$x,.data$PANEL),function(a) scales::label_percent(accuracy=.1)(a/sum(a)))),nrow=2,byrow=TRUE))),')',
                                 sep=''),
